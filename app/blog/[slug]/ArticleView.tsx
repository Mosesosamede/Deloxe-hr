...
<div className="max-w-5xl mx-auto px-6 -mt-20 sm:-mt-24 relative z-20 mb-12 md:mb-16">
  <div className="relative aspect-[16/9] md:aspect-[21/9] rounded-3xl md:rounded-[40px] overflow-hidden shadow-2xl border border-gray-200/90 ring-1 ring-black/5 bg-white p-0.5 md:p-1.5 transition-all duration-700 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.15)] group">
